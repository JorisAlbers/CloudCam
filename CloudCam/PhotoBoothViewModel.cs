...
namespace CloudCam
{
    public class PhotoBoothViewModel : ReactiveObject
    {
            ...
            OutputImageRepository outputImageRepository, List<string> pickupLines)
        {
            ...
            EffectManager effectManager = new EffectManager(@"Resources\Caff\deploy.prototxt", @"Resources\Caff\res10_300x300_ssd_iter_140000_fp16.caffemodel",  @"Resources\Cascades\haarcascade_mcs_nose.xml", mustachesRepository, hatsRepository);
